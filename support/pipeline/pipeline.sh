...
-t docker.pkg.github.com/queueing-systems-assistance/qsa-i18n-service/qsa-i18n-service:"${RELEASE_VERSION}" . || exit

sudo docker push docker.pkg.github.com/queueing-systems-assistance/qsa-i18n-service/qsa-i18n-service:"${RELEASE_VERSION}" || exit
